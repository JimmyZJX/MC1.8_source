...
/*  33: 86 */   private static final Map<String,String> d = Maps.newHashMap();
/*  34:    */   private static final Joiner e;
/*  35:    */   private final cvk f;
/*  36: 94 */   private final Map<oa,cue> g = Maps.newHashMap();
/*  37: 95 */   private final Map<oa,cmc> h = Maps.newLinkedHashMap();
/*  38: 96 */   private final Map<cxl,cmm> i = Maps.newLinkedHashMap();
...
/*  85:    */   }
/*  86:    */   
/*  87:124 */   private Map<String,oa> s = Maps.newLinkedHashMap();
/*  88:125 */   private final Map<oa,cmh> t = Maps.newHashMap();
/*  89:126 */   private Map<Item,ArrayList<String>> u = Maps.newIdentityHashMap();
/*  90:    */   
...
/* 127:    */   }
/* 128:    */   
/* 129:    */   private void a(Collection<cxl> paramCollection)
/* 130:    */   {
...
/* 162:    */     {
/* 163:187 */       ArrayList<cmh> localArrayList = Lists.newArrayList();
/* 164:    */       try
/* 165:    */       {
...
/* 200:    */   private void c()
/* 201:    */   {
/* 202:217 */     for (Iterator<cxl> localIterator1 = this.i.keySet().iterator(); localIterator1.hasNext();)
/* 203:    */     {
/* 204:217 */       cxl localcxl = localIterator1.next();
...
/* 223:    */   
/* 224:    */   private cmc c(oa paramoa) throws IOException
/* 225:    */   {
...
/* 243:    */     {
/* 244:251 */       String localObject2 = str.substring("builtin/".length());
...
/* 251:    */     else
/* 252:    */     {
/* 253:259 */       cvj localObject2 = this.f.a(d(paramoa));
/* 254:260 */       localObject1 = new InputStreamReader(((cvj)localObject2).b(), Charsets.UTF_8);
/* 255:    */     }
/* 256:    */     try
/* 257:    */     {
/* 258:264 */       cmc localObject2 = cmc.a((Reader)localObject1);
...
/* 274:    */   {
/* 275:277 */     e();
/* 276:279 */     for (Iterator<Item> localIterator1 = Item.e.iterator(); localIterator1.hasNext();)
/* 277:    */     {
/* 278:279 */       Item localalq = localIterator1.next();
/* 279:280 */       List<String> localList = a(localalq);
...
/* 291:    */           {
/* 292:294 */             c.warn("Unable to load item model: '" + localoa + "' for item: '" + Item.e.c(localalq) + "'", localException);
/* 293:    */           }
/* 294:    */         }
/* 295:    */       }
/* 296:    */     }   }
...
/* 300:    */   private void e()
/* 301:    */   {
/* 302:301 */     this.u.put(Item.fromBlock(BlockList.stone), Lists.newArrayList(new String[] { "stone", "granite", "granite_smooth", "diorite", "diorite_smooth", "andesite", "andesite_smooth" }));
/* 303:302 */     this.u.put(Item.fromBlock(BlockList.dirt), Lists.newArrayList(new String[] { "dirt", "coarse_dirt", "podzol" }));
/* 304:303 */     this.u.put(Item.fromBlock(BlockList.planks), Lists.newArrayList(new String[] { "oak_planks", "spruce_planks", "birch_planks", "jungle_planks", "acacia_planks", "dark_oak_planks" }));
/* 305:304 */     this.u.put(Item.fromBlock(BlockList.sapling), Lists.newArrayList(new String[] { "oak_sapling", "spruce_sapling", "birch_sapling", "jungle_sapling", "acacia_sapling", "dark_oak_sapling" }));
/* 306:305 */     this.u.put(Item.fromBlock(BlockList.sand), Lists.newArrayList(new String[] { "sand", "red_sand" }));
/* 307:306 */     this.u.put(Item.fromBlock(BlockList.log), Lists.newArrayList(new String[] { "oak_log", "spruce_log", "birch_log", "jungle_log" }));
/* 308:307 */     this.u.put(Item.fromBlock(BlockList.leaves), Lists.newArrayList(new String[] { "oak_leaves", "spruce_leaves", "birch_leaves", "jungle_leaves" }));
/* 309:308 */     this.u.put(Item.fromBlock(BlockList.v), Lists.newArrayList(new String[] { "sponge", "sponge_wet" }));
/* 310:309 */     this.u.put(Item.fromBlock(BlockList.A), Lists.newArrayList(new String[] { "sandstone", "chiseled_sandstone", "smooth_sandstone" }));
/* 311:310 */     this.u.put(Item.fromBlock(BlockList.cM), Lists.newArrayList(new String[] { "red_sandstone", "chiseled_red_sandstone", "smooth_red_sandstone" }));
/* 312:311 */     this.u.put(Item.fromBlock(BlockList.tallgrass), Lists.newArrayList(new String[] { "dead_bush", "tall_grass", "fern" }));
/* 313:312 */     this.u.put(Item.fromBlock(BlockList.deadbush), Lists.newArrayList(new String[] { "dead_bush" }));
/* 314:313 */     this.u.put(Item.fromBlock(BlockList.wool), Lists.newArrayList(new String[] { "black_wool", "red_wool", "green_wool", "brown_wool", "blue_wool", "purple_wool", "cyan_wool", "silver_wool", "gray_wool", "pink_wool", "lime_wool", "yellow_wool", "light_blue_wool", "magenta_wool", "orange_wool", "white_wool" }));
/* 315:314 */     this.u.put(Item.fromBlock(BlockList.yellowFlower), Lists.newArrayList(new String[] { "dandelion" }));
/* 316:315 */     this.u.put(Item.fromBlock(BlockList.redFlower), Lists.newArrayList(new String[] { "poppy", "blue_orchid", "allium", "houstonia", "red_tulip", "orange_tulip", "white_tulip", "pink_tulip", "oxeye_daisy" }));
/* 317:316 */     this.u.put(Item.fromBlock(BlockList.U), Lists.newArrayList(new String[] { "stone_slab", "sandstone_slab", "cobblestone_slab", "brick_slab", "stone_brick_slab", "nether_brick_slab", "quartz_slab" }));
/* 318:317 */     this.u.put(Item.fromBlock(BlockList.cP), Lists.newArrayList(new String[] { "red_sandstone_slab" }));
/* 319:318 */     this.u.put(Item.fromBlock(BlockList.cG), Lists.newArrayList(new String[] { "black_stained_glass", "red_stained_glass", "green_stained_glass", "brown_stained_glass", "blue_stained_glass", "purple_stained_glass", "cyan_stained_glass", "silver_stained_glass", "gray_stained_glass", "pink_stained_glass", "lime_stained_glass", "yellow_stained_glass", "light_blue_stained_glass", "magenta_stained_glass", "orange_stained_glass", "white_stained_glass" }));
/* 320:319 */     this.u.put(Item.fromBlock(BlockList.monsterEgg), Lists.newArrayList(new String[] { "stone_monster_egg", "cobblestone_monster_egg", "stone_brick_monster_egg", "mossy_brick_monster_egg", "cracked_brick_monster_egg", "chiseled_brick_monster_egg" }));
/* 321:320 */     this.u.put(Item.fromBlock(BlockList.stoneBrick), Lists.newArrayList(new String[] { "stonebrick", "mossy_stonebrick", "cracked_stonebrick", "chiseled_stonebrick" }));
/* 322:321 */     this.u.put(Item.fromBlock(BlockList.bM), Lists.newArrayList(new String[] { "oak_slab", "spruce_slab", "birch_slab", "jungle_slab", "acacia_slab", "dark_oak_slab" }));
/* 323:322 */     this.u.put(Item.fromBlock(BlockList.bZ), Lists.newArrayList(new String[] { "cobblestone_wall", "mossy_cobblestone_wall" }));
/* 324:323 */     this.u.put(Item.fromBlock(BlockList.cf), Lists.newArrayList(new String[] { "anvil_intact", "anvil_slightly_damaged", "anvil_very_damaged" }));
/* 325:324 */     this.u.put(Item.fromBlock(BlockList.cq), Lists.newArrayList(new String[] { "quartz_block", "chiseled_quartz_block", "quartz_column" }));
/* 326:325 */     this.u.put(Item.fromBlock(BlockList.cu), Lists.newArrayList(new String[] { "black_stained_hardened_clay", "red_stained_hardened_clay", "green_stained_hardened_clay", "brown_stained_hardened_clay", "blue_stained_hardened_clay", "purple_stained_hardened_clay", "cyan_stained_hardened_clay", "silver_stained_hardened_clay", "gray_stained_hardened_clay", "pink_stained_hardened_clay", "lime_stained_hardened_clay", "yellow_stained_hardened_clay", "light_blue_stained_hardened_clay", "magenta_stained_hardened_clay", "orange_stained_hardened_clay", "white_stained_hardened_clay" }));
/* 327:326 */     this.u.put(Item.fromBlock(BlockList.stainedGlassPane), Lists.newArrayList(new String[] { "black_stained_glass_pane", "red_stained_glass_pane", "green_stained_glass_pane", "brown_stained_glass_pane", "blue_stained_glass_pane", "purple_stained_glass_pane", "cyan_stained_glass_pane", "silver_stained_glass_pane", "gray_stained_glass_pane", "pink_stained_glass_pane", "lime_stained_glass_pane", "yellow_stained_glass_pane", "light_blue_stained_glass_pane", "magenta_stained_glass_pane", "orange_stained_glass_pane", "white_stained_glass_pane" }));
/* 328:327 */     this.u.put(Item.fromBlock(BlockList.leaves2), Lists.newArrayList(new String[] { "acacia_leaves", "dark_oak_leaves" }));
/* 329:328 */     this.u.put(Item.fromBlock(BlockList.log2), Lists.newArrayList(new String[] { "acacia_log", "dark_oak_log" }));
/* 330:329 */     this.u.put(Item.fromBlock(BlockList.cI), Lists.newArrayList(new String[] { "prismarine", "prismarine_bricks", "dark_prismarine" }));
/* 331:330 */     this.u.put(Item.fromBlock(BlockList.cy), Lists.newArrayList(new String[] { "black_carpet", "red_carpet", "green_carpet", "brown_carpet", "blue_carpet", "purple_carpet", "cyan_carpet", "silver_carpet", "gray_carpet", "pink_carpet", "lime_carpet", "yellow_carpet", "light_blue_carpet", "magenta_carpet", "orange_carpet", "white_carpet" }));
/* 332:331 */     this.u.put(Item.fromBlock(BlockList.cF), Lists.newArrayList(new String[] { "sunflower", "syringa", "double_grass", "double_fern", "double_rose", "paeonia" }));
...
/* 340:339 */     this.u.put(ItemList.skull, Lists.newArrayList(new String[] { "skull_skeleton", "skull_wither", "skull_zombie", "skull_char", "skull_creeper" }));
/* 341:    */     
/* 342:    */ 
/* 343:342 */     this.u.put(Item.fromBlock(BlockList.bo), Lists.newArrayList(new String[] { "oak_fence_gate" }));
/* 344:343 */     this.u.put(Item.fromBlock(BlockList.fence), Lists.newArrayList(new String[] { "oak_fence" }));
/* 345:344 */     this.u.put(ItemList.aq, Lists.newArrayList(new String[] { "oak_door" }));
/* 346:    */   }
/* 347:    */   
/* 348:    */   private List<String> a(Item paramalq)
/* 349:    */   {
/* 350:348 */     List<String> localList = this.u.get(paramalq);
/* 351:349 */     if (localList == null) {
/* 352:350 */       localList = Collections.singletonList(((oa)Item.e.c(paramalq)).toString());
/* 353:    */     }
...
/* 363:    */   private void f()
/* 364:    */   {
/* 365:362 */     for (Iterator<cxl> localIterator = this.i.keySet().iterator(); localIterator.hasNext();)
/* 366:    */     {
/* 367:362 */       cxl localObject1 = (cxl)localIterator.next();
/* 368:363 */       cxp localObject2 = new cxp();
/* 369:    */       
/* 370:365 */       int i1 = 0;
/* 371:366 */       for (Iterator<cmk> localObject3 = ((cmm)this.i.get(localObject1)).b().iterator(); localObject3.hasNext();)
/* 372:    */       {
/* 373:366 */         cmk localcmk = localObject3.next();
/* 374:367 */         cmc localcmc = this.h.get(localcmk.a());
...
/* 396:386 */     for (Iterator<Map.Entry<String, oa>> localIterator = this.s.entrySet().iterator(); localIterator.hasNext();)
/* 397:    */     {
/* 398:386 */       Map.Entry<String, oa> localObject1 = localIterator.next();
/* 399:387 */       localObject2 = (oa)(localObject1).getValue();
/* 400:388 */       cxl localcxl = new cxl((String)(localObject1).getKey(), "inventory");
...
/* 410:    */   }
/* 411:    */   
/* 412:    */   private Set<oa> g()
/* 413:    */   {
/* 414:403 */     HashSet<oa> localHashSet = Sets.newHashSet();
/* 415:    */     
/* 416:405 */     ArrayList<cxl> localArrayList = Lists.newArrayList(this.i.keySet());
/* 417:406 */     Collections.sort(localArrayList, new cxi(this));
/* 418:412 */     for (Iterator<cxl> localIterator1 = localArrayList.iterator(); localIterator1.hasNext();)
/* 419:    */     {
/* 420:412 */       cxl localcxl = (cxl)localIterator1.next();
...
/* 444:    */     {
/* 445:436 */       clu localclu = (clu)localIterator1.next();
/* 446:437 */       for (EnumDirection localej : localclu.c.keySet())
/* 447:    */       {
...
/* 459:    */   }
/* 460:    */   
/* 461:    */   private clt a(clu paramclu, clx paramclx, cue paramcue, EnumDirection paramej, cxf paramcxf, boolean paramBoolean)
/* 462:    */   {
...
/* 475:    */   private void i()
/* 476:    */   {
/* 477:467 */     ArrayDeque<oa> localArrayDeque = Queues.newArrayDeque();
/* 478:468 */     HashSet<oa> localHashSet = Sets.newHashSet();
/* 479:470 */     for (Iterator<oa> localObject1 = this.h.keySet().iterator(); localObject1.hasNext();)
/* 480:    */     {
/* 481:470 */       oa localObject2 = localObject1.next();
/* 482:471 */       localHashSet.add(localObject2);
/* 483:    */       
/* 484:473 */       oa localoa = ((cmc)this.h.get(localObject2)).e();
...
/* 492:    */     {
/* 493:480 */       oa localObject1 = (oa)localArrayDeque.pop();
/* 494:    */       try
/* 495:    */       {
/* 496:482 */         if (this.h.get(localObject1) != null) {
/* 497:    */           continue;
/* 498:    */         }
/* 499:486 */         cmc localObject21 = c((oa)localObject1);
/* 500:487 */         this.h.put(localObject1, localObject21);
/* 501:    */         
/* 502:489 */         localoa = ((cmc)localObject21).e();
...
/* 513:    */   }
/* 514:    */   
/* 515:    */   private List<oa> e(oa paramoa)
/* 516:    */   {
/* 517:501 */     ArrayList<oa> localArrayList = Lists.newArrayList(new oa[] { paramoa });
...
/* 526:    */   {
/* 527:511 */     for (Map.Entry<oa,cmc> localEntry : this.h.entrySet())
/* 528:    */     {
...
/* 535:    */   }
/* 536:    */   
/* 537:    */   private Set<oa> a(cmc paramcmc)
/* 538:    */   {
/* 539:522 */     HashSet<oa> localHashSet = Sets.newHashSet();
...
/* 574:    */   }
/* 575:    */   
/* 576:    */   private Set<oa> k()
/* 577:    */   {
/* 578:560 */     HashSet<oa> localHashSet = Sets.newHashSet();
/* 579:562 */     for (oa localoa1 : this.s.values())
/* 580:    */     {
/* 581:563 */       cmc localcmc = (cmc)this.h.get(localoa1);
/* 582:565 */       if (localcmc != null)
/* 583:    */       {
/* 584:569 */         localHashSet.add(new oa(localcmc.c("particle")));
/* 585:571 */         if (b(localcmc)) {
/* 586:572 */           for (Iterator<String> localIterator2 = cmr.a.iterator(); localIterator2.hasNext();)
/* 587:    */           {
/* 588:572 */             String localObject1 = localIterator2.next();
/* 589:573 */             oa localObject2 = new oa(localcmc.c(localObject1));
...
/* 598:582 */           for (Iterator<clu> localIterator2 = localcmc.a().iterator(); localIterator2.hasNext();)
/* 599:    */           {
/* 600:582 */             clu localObject1 = localIterator2.next();
/* 601:583 */             for (Iterator<clx> localObject2 = (localObject1).c.values().iterator(); ((Iterator)localObject2).hasNext();)
/* 602:    */             {
...
/* 636:    */   private void l()
/* 637:    */   {
/* 638:612 */     for (Iterator<oa> localIterator = this.s.values().iterator(); localIterator.hasNext();)
/* 639:    */     {
/* 640:612 */       oa localObject = localIterator.next();
...
/* 656:627 */     for (Iterator<cue> localIterator = this.g.values().iterator(); localIterator.hasNext();)
/* 657:    */     {
...
/* 668:    */   }
				static Map<oa,cue> a(cxh arg0) {return arg0.g;}
/* 669:    */ }
