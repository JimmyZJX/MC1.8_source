...
class axj {
	...
	static {
		...
		try {b[axk.b.ordinal()] = 1;} catch (NoSuchFieldError e) { }
		try {b[axk.c.ordinal()] = 2;} catch (NoSuchFieldError e) { }
		try {b[axk.d.ordinal()] = 3;} catch (NoSuchFieldError e) { }
		try {b[axk.e.ordinal()] = 4;} catch (NoSuchFieldError e) { }
		try {b[axk.f.ordinal()] = 5;} catch (NoSuchFieldError e) { }
		try {b[axk.g.ordinal()] = 6;} catch (NoSuchFieldError e) { }
		try {b[axk.a.ordinal()] = 7;} catch (NoSuchFieldError e) { }
		try {b[axk.h.ordinal()] = 8;} catch (NoSuchFieldError e) { }
