...
/* 12:   */   {
/* 13:15 */     super(paramaqu, paramwv.xPos, paramwv.getAABB().minY + paramwv.height / 2.0F, paramwv.zPos, paramwv.xVelocity, paramwv.yVelocity, paramwv.zVelocity);
...
/* 30:   */       {
/* 31:35 */         double d4 = this.a.xPos + d1 * this.a.width / 4.0D;
/* 32:36 */         double d5 = this.a.getAABB().minY + this.a.height / 2.0F + d2 * this.a.height / 4.0D;
/* 33:37 */         double d6 = this.a.zPos + d3 * this.a.width / 4.0D;
