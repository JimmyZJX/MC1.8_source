...
/*   8:    */   
/*   9:    */   protected axl(Material parambof)
/*  10:    */   {
...
/*  41: 54 */       return ((Integer)paramard.getBlock(paramdt).getProperty(b)).intValue();
/*  42:    */     }
/*  43: 57 */     return -1;
/*  44:    */   }
/*  45:    */   
...
/*  64:    */   {
/*  65: 78 */     return (paramBoolean) && (((Integer)parambec.getProperty(b)).intValue() == 0);
/*  66:    */   }
/*  67:    */   
...
/* 161:164 */     if (((Integer)paramard.getBlock(paramdt).getProperty(b)).intValue() >= 8) {
...
/* 216:    */     {
/* 217:217 */       int i = ((Integer)parambec.getProperty(b)).intValue();
/* 218:218 */       if ((i > 0) && (i < 8))
/* 219:    */       {
...
/* 291:286 */       if (i != 0)
/* 292:    */       {
/* 293:287 */         Integer localInteger = (Integer)parambec.getProperty(b);
...
/* 324:    */   {
/* 325:316 */     return instance().a(b, Integer.valueOf(paramInt));
/* 326:    */   }
/* 327:    */   
/* 328:    */   public int c(Block parambec)
/* 329:    */   {
/* 330:321 */     return ((Integer)parambec.getProperty(b)).intValue();
/* 331:    */   }
/* 332:    */   
/* 333:    */   protected bed e()
/* 334:    */   {
