...
/*  1:   */ public class GoalOpenVillageDoor
/*  2:   */   extends GoalType
/*  3:   */ {
/*  4:   */   private EntityWalkingMob mob;
/*  5:   */   private VillageDoor door;
/*  6:   */   
/*  7:   */   public GoalOpenVillageDoor(EntityWalkingMob mob)
/*  8:   */   {
/*  9:14 */     this.mob = mob;
/* 10:15 */     if (!(mob.getNavigator() instanceof aay)) {
...
/* 42:   */   {
/* 43:49 */     ((aay)this.mob.getNavigator()).b(false);
/* 44:50 */     ((aay)this.mob.getNavigator()).c(false);
/* 45:   */   }
/* 46:   */   
/* 47:   */   public void stop()
/* 48:   */   {
/* 49:55 */     ((aay)this.mob.getNavigator()).b(true);
/* 50:56 */     ((aay)this.mob.getNavigator()).c(true);
