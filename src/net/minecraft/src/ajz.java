...
/* 13:   */   }
/* 14:   */   
/* 15:   */   public void a(ItemStack paramamj, World paramaqu, EntityPlayer paramahd, int paramInt)
/* 16:   */   {
/* 17:27 */     int i = (paramahd.by.d) || (aph.a(Enchantment.y.B, paramamj) > 0) ? 1 : 0;
/* 18:29 */     if ((i != 0) || (paramahd.bg.b(ItemList.g)))
/* 19:   */     {
...
/* 32:   */       }
/* 33:44 */       int k = aph.a(Enchantment.v.B, paramamj);
/* 34:45 */       if (k > 0) {
/* 35:46 */         localahj.b(localahj.j() + k * 0.5D + 0.5D);
/* 36:   */       }
/* 37:48 */       int m = aph.a(Enchantment.w.B, paramamj);
/* 38:49 */       if (m > 0) {
/* 39:50 */         localahj.a(m);
/* 40:   */       }
/* 41:52 */       if (aph.a(Enchantment.x.B, paramamj) > 0) {
/* 42:53 */         localahj.e(100);
/* 43:   */       }
/* 44:55 */       paramamj.a(1, paramahd);
/* 45:   */       
/* 46:57 */       paramaqu.a(paramahd, "random.bow", 1.0F, 1.0F / (random.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
/* 47:58 */       if (i != 0) {
/* 48:59 */         localahj.a = 2;
/* 49:   */       } else {
/* 50:61 */         paramahd.bg.a(ItemList.g);
/* 51:   */       }
/* 52:63 */       paramahd.b(StatList.J[Item.b(this)]);
/* 53:64 */       if (!paramaqu.isClient) {
/* 54:65 */         paramaqu.spawnEntity(localahj);
/* 55:   */       }
/* 56:   */     }
/* 57:   */   }
/* 58:   */   
...
/* 75:   */   {
/* 76:87 */     if ((paramahd.by.d) || (paramahd.bg.b(ItemList.g))) {
