...
/* 656:718 */     a(321, "painting", new aln(adm.class).setID("painting"));
/* 657:719 */     a(322, "golden_apple", new alm(4, 1.2F, false).h().a(Potion.l.H, 5, 1, 1.0F).setID("appleGold"));
...
/* 701:763 */     a(365, "chicken", new all(2, 0.3F, true).a(Potion.s.H, 30, 0, 0.3F).setID("chickenRaw"));
/* 702:764 */     a(366, "cooked_chicken", new all(6, 0.6F, true).setID("chickenCooked"));
/* 703:765 */     a(367, "rotten_flesh", new all(4, 0.1F, true).a(Potion.s.H, 30, 0, 0.8F).setID("rottenFlesh"));
...
/* 709:771 */     a(373, "potion", new amw().setID("potion"));
/* 710:772 */     a(374, "glass_bottle", new ajy().setID("glassBottle"));
/* 711:773 */     a(375, "spider_eye", new all(2, 0.8F, false).a(Potion.u.H, 5, 0, 1.0F).setID("spiderEye").e(ans.d));
...
/* 725:787 */     a(389, "item_frame", new aln(adk.class).setID("frame"));
...
/* 730:792 */     a(394, "poisonous_potato", new all(2, 0.3F, false).a(Potion.u.H, 5, 0, 0.6F).setID("potatoPoisonous"));
