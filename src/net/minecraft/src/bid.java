...
/* 11:15 */       if ((BlockList.bk.c(paramaqu, localdt)) && (paramaqu.getBlock(localdt.down()).getProto() == BlockList.grass)) {
/* 12:16 */         paramaqu.setBlock(localdt, BlockList.bk.instance(), 2);
/* 13:   */       }
/* 14:   */     }
/* 15:20 */     return true;
/* 16:   */   }
