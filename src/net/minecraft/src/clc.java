...
/* 127:135 */     a(BlockList.ab, new cnh().a(new IBlockData[] { avx.a }).a());
/* 128:136 */     a(BlockList.af, new cnh().a(new IBlockData[] { azt.O }).a());
/* 129:137 */     a(BlockList.ao, new cnh().a(new IBlockData[] { avf.N }).a());
/* 130:138 */     a(BlockList.ap, new cnh().a(new IBlockData[] { avf.N }).a());
/* 131:139 */     a(BlockList.aq, new cnh().a(new IBlockData[] { avf.N }).a());
/* 132:140 */     a(BlockList.ar, new cnh().a(new IBlockData[] { avf.N }).a());
/* 133:141 */     a(BlockList.as, new cnh().a(new IBlockData[] { avf.N }).a());
/* 134:142 */     a(BlockList.at, new cnh().a(new IBlockData[] { avf.N }).a());
/* 135:143 */     a(BlockList.aA, new cnh().a(new IBlockData[] { avf.N }).a());
