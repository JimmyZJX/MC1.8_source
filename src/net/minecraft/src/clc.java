...
/* 109:117 */     a(BlockList.leaves, new cnh().a(ayp.P).a("_leaves").a(new bex[] { BlockLeaves.b, BlockLeaves.a }).a());
/* 110:118 */     a(BlockList.leaves2, new cnh().a(ayg.P).a("_leaves").a(new bex[] { BlockLeaves.b, BlockLeaves.a }).a());
/* 111:119 */     a(BlockList.cactus, new cnh().a(new bex[] { auf.a }).a());
/* 112:120 */     a(BlockList.reeds, new cnh().a(new bex[] { azy.a }).a());
/* 113:121 */     a(BlockList.aN, new cnh().a(new bex[] { axc.a }).a());
/* 114:122 */     a(BlockList.bX, new cnh().a(new bex[] { auo.a }).a());
/* 115:123 */     a(BlockList.bZ, new cnh().a(bbx.P).a("_wall").a());
/* 116:124 */     a(BlockList.cF, new cnh().a(avi.a).a());
/* 117:125 */     a(BlockList.bo, new cnh().a(new bex[] { avw.b }).a());
/* 118:126 */     a(BlockList.bp, new cnh().a(new bex[] { avw.b }).a());
/* 119:127 */     a(BlockList.bq, new cnh().a(new bex[] { avw.b }).a());
/* 120:128 */     a(BlockList.br, new cnh().a(new bex[] { avw.b }).a());
/* 121:129 */     a(BlockList.bs, new cnh().a(new bex[] { avw.b }).a());
/* 122:130 */     a(BlockList.bt, new cnh().a(new bex[] { avw.b }).a());
/* 123:131 */     a(BlockList.tripwire, new cnh().a(new bex[] { bbs.N, bbs.a }).a());
/* 124:132 */     a(BlockList.bL, new cnh().a(ayw.a).a("_double_slab").a());
/* 125:133 */     a(BlockList.bM, new cnh().a(ayw.a).a("_slab").a());
/* 126:134 */     a(BlockList.W, new cnh().a(new bex[] { bbk.a }).a());
/* 127:135 */     a(BlockList.ab, new cnh().a(new bex[] { avx.a }).a());
/* 128:136 */     a(BlockList.af, new cnh().a(new bex[] { azt.O }).a());
/* 129:137 */     a(BlockList.ao, new cnh().a(new bex[] { avf.N }).a());
/* 130:138 */     a(BlockList.ap, new cnh().a(new bex[] { avf.N }).a());
/* 131:139 */     a(BlockList.aq, new cnh().a(new bex[] { avf.N }).a());
/* 132:140 */     a(BlockList.ar, new cnh().a(new bex[] { avf.N }).a());
/* 133:141 */     a(BlockList.as, new cnh().a(new bex[] { avf.N }).a());
/* 134:142 */     a(BlockList.at, new cnh().a(new bex[] { avf.N }).a());
/* 135:143 */     a(BlockList.aA, new cnh().a(new bex[] { avf.N }).a());
...
/* 139:147 */     a(BlockList.stained_glass_pane, new cnh().a(aun.a).a("_stained_glass_pane").a());
...
/* 144:152 */     a(BlockList.C, new cnh().a(new bex[] { atp.b }).a());
...
/* 151:159 */     a(BlockList.z, new cnh().a(new bex[] { ave.b }).a());
/* 152:160 */     a(BlockList.ct, new cnh().a(new bex[] { avm.b }).a());
...
/* 158:166 */     a(BlockList.cp, new cnh().a(new bex[] { BlockHopper.b }).a());
/* 159:167 */     a(BlockList.ca, new cnh().a(new bex[] { awd.a }).a());
/* 160:    */     
