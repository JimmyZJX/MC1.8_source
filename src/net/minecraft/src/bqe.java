...
/*  32:    */   }
/*  33:    */   
/*  34:    */   public void a(NBTTagCompound tag)
/*  35:    */   {
...
/*  68:    */   }
/*  69:    */   
/*  70:    */   public void b(NBTTagCompound tag)
/*  71:    */   {
...
/*  96:151 */       if ((localbqf.a.isDead) || ((!localbqf.a.bg.c(paramamj)) && (!paramamj.y())))
/*  97:    */       {
/*  98:152 */         this.i.remove(localbqf.a);
/*  99:153 */         this.g.remove(localbqf);
/* 100:    */       }
/* 101:154 */       else if ((!paramamj.y()) && (localbqf.a.am == this.dimension))
/* 102:    */       {
/* 103:155 */         a(0, localbqf.a.world, localbqf.a.getName(), localbqf.a.xPos, localbqf.a.zPos, localbqf.a.yaw);
/* 104:    */       }
/* 105:    */     }
/* 106:    */     
...
/* 111:162 */       a(1, paramahd.world, "frame-" + localObject1.getID(), pos.getX(), pos.getZ(), localObject1.b.b() * 90);
/* 112:    */     }
...
/* 120:170 */           a(localfn.d("type"), paramahd.world, localfn.getString("id"), localfn.i("x"), localfn.i("z"), localfn.i("rot"));
/* 121:    */         }
/* 122:    */       }
/* 123:    */     }
/* 124:    */   }
/* 125:    */   
/* 126:    */   private void a(int type, World world, String paramString, double x, double z, double yaw)
/* 127:    */   {
...
/* 163:    */     else
/* 164:    */     {
/* 165:209 */       this.icons.remove(paramString);
/* 166:210 */       return;
/* 167:    */     }
/* 168:213 */     this.icons.put(paramString, new MapIcon((byte)type, mapX, mapY, orientation));
/* 169:    */   }
/* 170:    */   
