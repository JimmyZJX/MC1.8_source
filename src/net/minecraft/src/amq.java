...
/* 32:41 */       EnumRailState localatl2 = (((Block)localObject).getProto() instanceof ati) ? (EnumRailState)((Block)localObject).getProperty(((ati)((Block)localObject).getProto()).l()) : EnumRailState.a;
