...
/* 17:   */   {
/* 18:   */     BlockType localatr;
/* 19:27 */     while ((((localatr = paramaqu.getBlock(paramdt).getType()).getMaterial() == Material.air) || (localatr.getMaterial() == Material.leaves)) && (paramdt.getY() > 1)) {
