...
/*   3:    */ { a(0,"stone") {
					@Override
					public Block d() {
						return BlockList.stone.instance().setData(bba.a, EnumStoneVariants.STONE);
					}
				},
				...
				c(2,"stone_brick","brick") {
					@Override
					public Block d() {
						return BlockList.stoneBrick.instance().setData(bbc.a, bbd.a);
					}
				},
				d(3,"mossy_brick","mossybrick") {
					@Override
					public Block d() {
						return BlockList.stoneBrick.instance().setData(bbc.a, bbd.b);
					}
				},
				e(4,"cracked_brick","crackedbrick") {
					@Override
					public Block d() {
						return BlockList.stoneBrick.instance().setData(bbc.a, bbd.c);
					}
				},
				f(5,"chiseled_brick","chiseledbrick") {
					@Override
					public Block d() {
						return BlockList.stoneBrick.instance().setData(bbc.a, bbd.d);
					}
				};
