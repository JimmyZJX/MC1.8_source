...
/*  73: 91 */     int i = 0;
/*  74:    */     
/*  75: 93 */     i |= ((bbg)parambec.getData(M)).a();
/*  76: 95 */     if (j())
/*  77:    */     {
/*  78: 96 */       if (((Boolean)parambec.getData(b)).booleanValue()) {
/*  79: 97 */         i |= 0x8;
/*  80:    */       }
/*  81:    */     }
/*  82:100 */     else if (parambec.getData(half) == EnumSlabHalf.TOP) {
/*  83:101 */       i |= 0x8;
/*  84:    */     }
/*  85:105 */     return i;
/*  86:    */   }
...
/*  97:    */   {
/*  98:119 */     return ((bbg)parambec.getData(M)).a();
/*  99:    */   }
/* 100:    */ }
