...
/*  13: 26 */   private static final List c = Lists.newArrayList(new vl[] { new vl(ItemList.saddle, 0, 1, 1, 10), new vl(ItemList.ironIngot, 0, 1, 4, 10), new vl(ItemList.bread, 0, 1, 1, 10), new vl(ItemList.O, 0, 1, 4, 10), new vl(ItemList.H, 0, 1, 4, 10), new vl(ItemList.F, 0, 1, 4, 10), new vl(ItemList.aw, 0, 1, 1, 10), new vl(ItemList.ao, 0, 1, 1, 1), new vl(ItemList.aC, 0, 1, 4, 10), new vl(ItemList.cq, 0, 1, 1, 4), new vl(ItemList.cr, 0, 1, 1, 4), new vl(ItemList.nameTag, 0, 1, 1, 10), new vl(ItemList.cl, 0, 1, 1, 2), new vl(ItemList.ck, 0, 1, 1, 5), new vl(ItemList.cm, 0, 1, 1, 1) });
/*  14:    */   
