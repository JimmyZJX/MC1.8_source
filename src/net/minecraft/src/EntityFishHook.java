...
/*   6:    */   extends Entity
/*   7:    */ {
/*   8: 36 */   private static final List<adp> junks = Arrays.asList(new adp[] { new adp(new ItemStack(ItemList.leatherBoots), 10).a(0.9F), new adp(new ItemStack(ItemList.leather), 10), new adp(new ItemStack(ItemList.bone), 10), new adp(new ItemStack(ItemList.bz), 10), new adp(new ItemStack(ItemList.F), 5), new adp(new ItemStack(ItemList.fishingRod), 2).a(0.9F), new adp(new ItemStack(ItemList.z), 10), new adp(new ItemStack(ItemList.stick), 5), new adp(new ItemStack(ItemList.dye, 10, EnumDyeColor.BLACK.b()), 1), new adp(new ItemStack(BlockList.bR), 10), new adp(new ItemStack(ItemList.bt), 10) });
