...
/*  12:    */ {
/*  13: 23 */   protected static Map<String,tq> a = Maps.newHashMap();
/*  14: 25 */   public static List<tq> b = Lists.newArrayList();
/*  15: 26 */   public static List<tq> c = Lists.newArrayList();
...
/*  41: 57 */   public static tq fishCaught = new tn("stat.fishCaught", new hz("stat.fishCaught", new Object[0])).h();
/*  42: 58 */   public static tq junkFished = new tn("stat.junkFished", new hz("stat.junkFished", new Object[0])).h();
/*  43: 59 */   public static tq treasureFished = new tn("stat.treasureFished", new hz("stat.treasureFished", new Object[0])).h();
/*  44: 60 */   public static tq talkedToVillager = new tn("stat.talkedToVillager", new hz("stat.talkedToVillager", new Object[0])).h();
/*  45: 61 */   public static tq tradedWithVillager = new tn("stat.tradedWithVillager", new hz("stat.tradedWithVillager", new Object[0])).h();
...
/* 175:    */   }
/* 176:    */   
/* 177:    */   private static void a(tq[] paramArrayOftq, ProtoBlock paramatr1, ProtoBlock paramatr2)
/* 178:    */   {
