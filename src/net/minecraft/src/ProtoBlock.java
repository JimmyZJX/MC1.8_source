...
/*  919: 995 */     a(64, "wooden_door", new BlockDoor(Material.wood).c(3.0F).a(f).setName("doorOak").J());
...
/* 1057:1133 */     a(196, "acacia_door", new BlockDoor(Material.wood).c(3.0F).a(f).setName("doorAcacia").J());
